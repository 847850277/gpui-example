use gpui::{
    canvas, div, linear_color_stop, linear_gradient, point, prelude::*, px, size, App, Application, Bounds, ColorSpace, Context, Half, Render, Window, WindowBounds, WindowOptions
};
